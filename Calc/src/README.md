...
Проверяемая точность дробной части - 5 знаков после запятой  
...
- make clang      проверить соответствие стилю Google
```
...
> Цель `dist` создает архив "s21_calc_v1.0.tar", в котором упакованы файлы программы, необходимые для ее установки и запуска на других машинах.  
...
> - упаковка содержимого этой директории в архив "s21_calc_v1.0.tar"  
>    
...
Демонтрация работы некоторой функции из калькулятора:

![Alt текст](img/MainCalc.gif) 
...
| Оператор взятия остатка от деления | `mod` |
...
## Материалы, прочитанные и просмотренные, во время и для выполнения задания  
   ...
   ### gui
   [Заводим трактор: QMake -> CMake](https://habr.com/ru/articles/577154/)  
